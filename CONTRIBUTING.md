# Contributing to PycordUtils

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to Pycord. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
* [Discord Server](https://discord.gg/qPcknbjAmb)
...
Bugs are tracked as [GitHub issues](https://guides.github.com/features/issues/). Create an issue on that repository and provide the following information by filling in [the template](https://github.com/xFGhoul/PycordUtils/blob/master/bug_report.md).
...
This wonderful `CONTRIBUTING.md` File was used from [Atom](https://github.com/atom/atom) As Inspiration.